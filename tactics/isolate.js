    ...
    "techniques": [
        ...
        },
        {
            ...
            "implementationStrategies": [
                ...
                {
                    "strategy": "Enforce budget-triggered throttling and safe-mode downgrade when per-session, per-user, per-agent, or per-API-key token and spend thresholds are exceeded or when abnormal cost-abuse scores cross policy thresholds.",
                ...
                {
                    "strategy": "Apply multi-dimensional quotas such as input-token ceilings, output-token ceilings, tool-call ceilings, and cumulative session budget ceilings so cost abuse cannot evade control by shifting from one resource dimension to another.",
                ...
                {
                    "strategy": "Escalate from soft throttling to hard containment when budget exhaustion is paired with suspicious signals such as recursive tool loops, repeated retries, anomalous latency growth, or high-confidence abuse detections.",
        ...
        },
        {
            ...
            "subTechniques": [
                ...
                },
                {
                    ...
                    "implementationStrategies": [
                        {
                            "strategy": "Attach freshness metadata such as creation time, expiry time, last access time, last validation time, and trust tier to every persistent memory record.",
                        ...
                        {
                            "strategy": "Automatically downgrade or quarantine trusted memory that exceeds TTL or staleness thresholds until it is re-validated by policy or human review.",
                        ...
                        {
                            "strategy": "Apply forced forgetting policies for session-scoped, user-preference, or privacy-sensitive memory classes so they are deleted at session end or after defined retention windows.",
                        ...
                        {
                            "strategy": "Propagate deletion and downgrade actions across derived artifacts such as embeddings, summaries, secondary indexes, caches, and replicas instead of deleting only the primary record.",
