    ...
    },
    {
      ...
      subTechniques: [
        ...
        },
        {
          ...
          phase: ["building", "operation"],
          description:
            "Utilizes the Agent Name Service (ANS) as a decentralized, verifiable directory for AI agents[cite: 17, 36]. It enforces a secure resolution protocol where all discovery responses are digitally signed by the registry[cite: 332, 470]. By implementing a full RA/CA lifecycle, TTL-based revalidation, and mandatory revocation checks (CRL/OCSP), this defense prevents registry poisoning, identity impersonation, and the use of hijacked or stale agent endpoints[cite: 110, 120, 134, 479, 814].",
          defendsAgainst: [
            {
              framework: "MITRE ATLAS",
