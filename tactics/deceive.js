    ...
    "techniques": [
        ...
        },
        {
            ...
            "implementationGuidance": [
                ...
                {
                    "implementation": "Ensure watermarks/telemetry don't degrade performance or UX.",
                ...
                {
                    "implementation": "Develop robust methods for detecting watermarks/telemetry externally.",
        ...
        },
        {
            ...
            "implementationGuidance": [
                {
                    "implementation": "Equip agent with shadow/canary goal/tool leading to monitored environment.",
        ...
        },
        {
            ...
            "implementationGuidance": [
                {
                    "implementation": "Add calibrated noise directly to input data during each training step.",
                ...
                {
                    "implementation": "Apply label smoothing to prevent the model from becoming over-confident in its predictions.",
                ...
                {
                    "implementation": "Apply differentially private training by leveraging AID-H-005.001, where privacy-preserving noise also serves as inversion resistance.",
                    "howTo": "<h5>Concept:</h5><p>Differentially private training is already defined in detail in <code>AID-H-005.001</code>. In this technique, its role is narrower: the privacy-preserving noise introduced during training also reduces inversion and membership-inference signal strength by limiting how strongly any single record can influence the trained model.</p><h5>Boundary</h5><p>Do not duplicate the full DP-SGD implementation here. Use <code>AID-H-005.001</code> as the canonical implementation reference for privacy-preserving training, and treat this strategy as the model-inversion-defense interpretation of that same control.</p><p><strong>Action:</strong> Where model inversion or membership inference is a material concern, apply differential privacy controls from <code>AID-H-005.001</code> and document that the same control also functions as training-phase obfuscation against reconstruction of individual records.</p>"
                }
            ],
            "toolsOpenSource": [
            ...
            "defendsAgainst": [
                ...
                },
                {
                    "framework": "Google Secure AI Framework 2.0 - Risks",
                    "items": [
                        "SDD: Sensitive Data Disclosure (training noise prevents disclosure of memorized training data)",
                        "ISD: Inferred Sensitive Data (label smoothing and noise reduce sensitive inference signals)"
                    ]
                },
                {
                    "framework": "Databricks AI Security Framework 3.0",
                    "items": [
                        "Model Management 8.4: Model inversion (noise and label smoothing frustrate model inversion)",
                        "Model Serving — Inference requests 9.2: Model inversion (training obfuscation prevents reconstruction of private data)",
                        "Model Serving — Inference requests 9.5: Infer training data membership (noise prevents membership inference)"
                    ]
                }
            ]
        },
        {
            ...
            "implementationGuidance": [
                {
                    "implementation": "Craft and inject synthetic canary data points into the training set.",
                ...
                {
                    "implementation": "Continuously monitor the model's loss and prediction accuracy specifically on the canary data points during training.",
                ...
                {
                    "implementation": "Ensure canary data is statistically similar to real data to evade attacker filtering.",
